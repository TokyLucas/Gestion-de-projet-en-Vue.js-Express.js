<script setup lang="ts">
    ...
    function login() {
        ...
        var request = userRepository.login(formData);
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form @submit.prevent="login" class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="col-span-2">
                        <div v-if="state.loginError" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                            <span class="font-medium">Erreur: </span>{{ state.loginError }}
                        </div>
                    </div>
                    <div>
                    ...
                    <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        <span v-if="!state.isLoading">Se connecter</span>
